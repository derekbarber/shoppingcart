...
export let cards = [
  { id: 1, category: 1, selected: false, name: "By Low", cards: ["$25", "$50", "$100"] },
  {
    id: 2,
    category: 1,
    selected: false,
  ...
  { id: 3, category: 1, selected: false, name: "Fresh St. Market", cards: ["$50"] },
  { id: 4, category: 1, selected: false, name: "Nesters", cards: ["$25", "$50", "$100", "$250"] },
  ...
  { id: 8, category: 1, selected: false, name: "M&M Meats", cards: ["$25"] },
  ...
  },
  {
    ...
    category: 2,
    selected: false,
    name: "Kelseys / NY Fries / Montana's / Swiss Chalet",
    cards: ["$25", "$50"],
  },
  {
    id: 26,
